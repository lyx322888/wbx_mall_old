...
//            }
     ...
     */
    private void sendToSamsumg(int notificationNum) {
        Intent localIntent = new Intent("android.intent.action.BADGE_COUNT_UPDATE");
        localIntent.putExtra("badge_count", notificationNum);//数字
        localIntent.putExtra("badge_count_package_name",appContext.getPackageName());//包名
