...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    private void getOpenID(String code) {
        ...
        try {
            //GET请求直接在链接后面拼上请求参数
            String mPath = "https://api.icon_wechat_pay.qq.com/sns/oauth2/access_token?";
    ...
    private void getWeChatUserInfo(String openId, String accessToken) {
        ...
        //关闭输入流
            ...
            WeChatUserInfoBean weChatUserInfoBean = new Gson().fromJson(result.toString(), WeChatUserInfoBean.class);
