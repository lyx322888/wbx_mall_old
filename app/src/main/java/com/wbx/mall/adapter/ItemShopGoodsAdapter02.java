...
public class ItemShopGoodsAdapter02 extends BaseQuickAdapter<GoodsInfo2, BaseViewHolder> {

    //    public ItemShopGoodsAdapter02(List<ShopInfo3.GoodsBean> dataList, Context context) {
//        super(dataList, context);
//    }
    ItemShopGoodsAdapter02(@Nullable List<GoodsInfo2> data) {
        super(R.layout.item_shop_goods_layout02, data);
    }

//    @Override
//    public int getLayoutId(int viewType) {
//        return R.layout.item_shop_goods_layout02;
//    }
    ...
    public void convert(BaseViewHolder holder, GoodsInfo2 goodsInfo) {
        ...
        holder.setText(R.id.goods_name_tv, goodsInfo.getTitle()).setText(R.id.goods_price_tv, String.format("店内价:" + "¥%.2f", goodsInfo.getSales_promotion_price() == 0 ? goodsInfo.getPrice() / 100.00 : goodsInfo.getSales_promotion_price() / 100.00));
