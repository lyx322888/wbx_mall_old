...
public class IntelligentPayListAdapter extends RecyclerView.Adapter<IntelligentPayListAdapter.MyViewHolder> {
    private Context mContext;

    private List<IntelligentPayBean> lstData = new ArrayList<>();

    public IntelligentPayListAdapter(Context context) {
        mContext = context;
    }

    public void update(List<IntelligentPayBean> data) {
        lstData.clear();
        lstData.addAll(data);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_intelligent_pay_list, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        IntelligentPayBean data = lstData.get(position);
