...
import com.wbx.mall.widget.filter.adapter.MenuAdapter;
import com.wbx.mall.widget.filter.adapter.SimpleTextAdapter;
import com.wbx.mall.widget.filter.betterDoubleGrid.BetterDoubleGridView;
import com.wbx.mall.widget.filter.betterDoubleGrid.doubleGrid.DoubleGridView;
import com.wbx.mall.widget.filter.entity.FilterType;
import com.wbx.mall.widget.filter.entity.FilterUrl;
import com.wbx.mall.widget.filter.interfaces.OnFilterDoneListener;
import com.wbx.mall.widget.filter.interfaces.OnFilterItemClickListener;
import com.wbx.mall.widget.filter.typeview.DoubleListView;
import com.wbx.mall.widget.filter.typeview.SingleGridView;
import com.wbx.mall.widget.filter.typeview.SingleListView;
import com.wbx.mall.widget.filter.util.CommonUtil;
