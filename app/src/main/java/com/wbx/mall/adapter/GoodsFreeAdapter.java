...
//    private AddSkWidget.OnAddClick onAddClick;
    ...
    public GoodsFreeAdapter(int layoutResId, @Nullable List<StoreDetailBean.SeckillGoodsBean> data) {
        super(layoutResId, data);
//        this.onAddClick = onAddClick;
    }

    @Override
    protected void convert(BaseViewHolder helper, StoreDetailBean.SeckillGoodsBean item) {
