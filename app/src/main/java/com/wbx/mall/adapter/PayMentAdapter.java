...
public class PayMentAdapter extends BaseAdapter<PaymentInfo,Context> {
    public PayMentAdapter(List<PaymentInfo> dataList, Context context) {
        super(dataList, context);
    }
    @Override
    public int getLayoutId(int viewType) {
        return R.layout.item_pay_ment;
    }

    @Override
    public void convert(BaseViewHolder holder, PaymentInfo paymentBean, int position) {
        TypedArray ar = mContext.getResources().obtainTypedArray(R.array.pay_ment_array);
