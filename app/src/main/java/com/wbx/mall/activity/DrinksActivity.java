...
public class DrinksActivity extends BaseActivity implements BaseRefreshListener {
...
//        titleImage.setImageResource(R.drawable.nearby_title);
    ...
    public void fillData() {
        mBannerIm.setImageResource(R.drawable.banner_drinks);
        //广播接受者实例
