...
public class FoodsActivity extends BaseActivity implements BaseRefreshListener {
    ...
    public void initView() {
        ...
        titleImage.setImageResource(R.drawable.prom_title);
    ...
    public void fillData() {
        ...
        TypedArray ar = getResources().obtainTypedArray(R.array.cate_type_src);
        int len = ar.length();
        ...
        String[] stringArray = getResources().getStringArray(R.array.cate_type_str);
        ...
        mShopAdapter = new ShopGoodsAdapter(shopInfoList, mContext);
    ...
    public void setListener() {
        mTypeAdapter.setOnItemClickListener(R.id.root_view, new BaseAdapter.ItemClickListener() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                shopInfoList.clear();
                mParams.put("cate_id", AppConfig.getCateId(position));
                getShopList();
            }
        });
