...
public class AddSkWidget extends FrameLayout {
    private View sub;
    private TextView tv_count;
    private int count;
    private AddButton addbutton;
    private boolean sub_anim, circle_anim;
    private BuygreensGoodsBean.DataBean.SeckillGoodsBean goodsInfo;
    private List<BuygreensGoodsBean.DataBean.SeckillGoodsBean> goodsBeans;

    public interface OnAddClick {

        void onAddClick(View view, BuygreensGoodsBean.DataBean.SeckillGoodsBean goodsInfo);

        void onSubClick(BuygreensGoodsBean.DataBean.SeckillGoodsBean goodsInfo);

        void onClickSpecs(BuygreensGoodsBean.DataBean.SeckillGoodsBean goodsInfo);
    }
    private OnAddClick onAddClick;

    public AddSkWidget(@NonNull Context context) {
        super(context);
    }

    public AddSkWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        addbutton.setAnimListner(new AddButton.AnimListner() {
            ...
            public void onStop() {
                ...
                if (goodsInfo.getIs_attr() == 1 || (goodsInfo.getNature() != null && goodsInfo.getNature().size() > 0)) {
                    ...
                    if (goodsInfo.getLimitations_num() != 0) {
                        //秒杀商品
                    ...
                    goodsInfo.getHmBuyNum().put(goodsInfo.getProduct_id() + ",,", count);
                    if (onAddClick != null) {
    ...
    public void setData(OnAddClick onAddClick, BuygreensGoodsBean.DataBean.SeckillGoodsBean goodsInfo) {
