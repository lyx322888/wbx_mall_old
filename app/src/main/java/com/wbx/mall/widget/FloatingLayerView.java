...
public class FloatingLayerView extends LinearLayout implements View.OnTouchListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        floating_width = getMeasuredWidth();
        floating_height = getMeasuredHeight();
        /**
         * 每次滑动的距离是当前View高度的5分之一。
         */
        move_height = floating_height / 5 + DisplayUtil.dip2px(20);
    }
    ...
    private void half2None() {
        float[] values = new float[]{move_height, getHeight() + 200};
    ...
    private void all2None() {
        float[] values = new float[]{0, getHeight() + 200};
        startAnimation(values);
        setType(HALF);
    }
