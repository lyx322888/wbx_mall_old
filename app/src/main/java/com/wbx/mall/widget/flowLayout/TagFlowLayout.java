...
public class TagFlowLayout extends FlowLayout
    ...
    private boolean canAllUnSelected = false;

    public void setCanAllUnSelected(boolean canAllUnSelected) {
        this.canAllUnSelected = canAllUnSelected;
    }
    ...
    private void changeAdapter() {
        ...
        if (mOnSelectListener != null) {
            mOnSelectListener.onSelected(preCheckedList);
        }
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tagViewContainer.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (finalTagViewContainer.isChecked() && !canAllUnSelected && mSelectedView.size() == 1) {
                        return;
                    }
