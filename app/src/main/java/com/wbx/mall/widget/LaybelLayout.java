...
public class LaybelLayout extends ViewGroup implements View.OnClickListener {
    ...
    public static class Adapter {
        ...
        public Adapter(List<CharSequence> datas) {
            mDatas = datas;
        }

        public Adapter(CharSequence... datas) {
            mDatas = Arrays.asList(datas);
        }

        public List<CharSequence> getDatas() {
            return mDatas;
        }
        ...
        public void onDataSet(View v, CharSequence data) {
        }
    }
    ...
    public List<View> getmChildView() {
        return mChildView;
    }
}
