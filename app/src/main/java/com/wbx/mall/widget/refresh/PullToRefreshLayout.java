package com.wbx.mall.widget.refresh;
...
import com.wbx.mall.widget.refresh.view.FooterView;
import com.wbx.mall.widget.refresh.view.HeadRefreshView;
import com.wbx.mall.widget.refresh.view.HeadView;
import com.wbx.mall.widget.refresh.view.LoadMoreView;
...
public class PullToRefreshLayout extends FrameLayout {
    ...
    private void cal() {
        head_height = DisplayUtil.dip2px(HEAD_HEIGHT);
        foot_height = DisplayUtil.dip2px(FOOT_HEIGHT);
        head_height_2 = DisplayUtil.dip2px( HEAD_HEIGHT * 2);
        foot_height_2 = DisplayUtil.dip2px(FOOT_HEIGHT * 2);
    ...
    private void showLoadingView() {
        if (loadingView == null) {
            ...
            ImageView loadingIm = loadingView.findViewById(R.id.loading_im);
    ...
    public void setHeadHeight(int dp) {
        head_height = DisplayUtil.dip2px( dp);
    }
    ...
    public void setFootHeight(int dp) {
        foot_height = DisplayUtil.dip2px( dp);
    }
    ...
    public void setAllHeight(int refresh, int loadMore) {
        head_height = DisplayUtil.dip2px(refresh);
        foot_height = DisplayUtil.dip2px(loadMore);
    }
    ...
    public void setMaxHeadHeight(int dp) {
        if (head_height >= DisplayUtil.dip2px( dp)) {
            return;
        }
        head_height_2 = DisplayUtil.dip2px(dp);
    }
    ...
    public void setMaxFootHeight(int dp) {
        if (foot_height >= DisplayUtil.dip2px(dp)) {
            return;
        }
        foot_height_2 = DisplayUtil.dip2px(dp);
    }
    ...
    public void setAllMaxHeight(int refresh, int loadMore) {
        if (head_height >= DisplayUtil.dip2px(refresh)) {
            return;
        }
        if (foot_height >= DisplayUtil.dip2px(loadMore)) {
            return;
        }
        head_height_2 = DisplayUtil.dip2px( refresh);
        foot_height_2 = DisplayUtil.dip2px(loadMore);
    }
    //无网络时候反射机制请求
