...
public class NewAddWidget extends FrameLayout {
    private View sub;
    private TextView tv_count;
    private int count;
    private AddButton addbutton;
    private boolean sub_anim, circle_anim;
    private GoodsInfo3 goodsInfo;

    public interface OnAddClick {

        void onAddClick(View view, GoodsInfo3 goodsInfo);

        void onSubClick(GoodsInfo3 goodsInfo);

        void onClickSpecs(GoodsInfo3 goodsInfo);
    }

    private NewAddWidget.OnAddClick onAddClick;

    public NewAddWidget(@NonNull Context context) {
        super(context);
    }

    public NewAddWidget(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setData(NewAddWidget.OnAddClick onAddClick, GoodsInfo3 goodsInfo) {
    ...
    public NewAddWidget.OnAddClick getOnAddClick() {
        return onAddClick;
    }
}
