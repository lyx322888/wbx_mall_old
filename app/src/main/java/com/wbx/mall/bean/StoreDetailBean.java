...
public class StoreDetailBean implements Serializable {
    ...
    public ShopInfo2 getDetail() {
        return detail;
    }

    public void setDetail(ShopInfo2 detail) {
        this.detail = detail;
    }
    ...
    public static class SeckillGoodsBean {
        ...
        private List<?> nature;
        private List<SeckillGoodsBean.GoodsAttrBean> goods_attr;
        ...
        public List<SeckillGoodsBean.GoodsAttrBean> getGoods_attr() {
            return goods_attr;
        }

        public void setGoods_attr(List<SeckillGoodsBean.GoodsAttrBean> goods_attr) {
